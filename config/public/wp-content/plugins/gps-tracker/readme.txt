...
Plugin URI: https://www.websmithing.com/gps-tracker-for-wordpress/
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8062483
Contributors: nicolasfox
Tags: android, gps, cell, phone, tracker, google, map, openstreetview, track, websmithing
...
Track your Android cell phone in real time and store routes for later viewing.

== Description ==

This is the first and only WordPress plugin that allows you to track your Android cell phone in real time. You can watch the cell phone being tracked using google maps or OpenStreetView maps and you can store and reload routes easily for later viewing. The plugin is fully responsive and this means that it will display properly on any device such as a cell phone, tablet or desktop computer.

View a working sample of the plugin here:

https://www.websmithing.com/gps-tracker-for-wordpress/

I hope you find this plugin useful, please rate it and leave a review. Thanks!

== Installation ==

1. Download the plugin and add it to your WordPress plugins directory.
2. Add this shortcode to any page or post: [gps_tracker]
3. Download Gps Tracker from the Google Play Store onto your Android cell phone and add your user name. Change the website url to your website.
...
= I want to track more than one cell phone, what can I do? =

This plugin allows you to track one Android cell phone for personal use. If you wish to track more than one cell phone, then you will need to purchase a 5-pack for $29 or a 10-pack for $49. The single license plugin is free and the multi-pack plugins will be available in late November, 2014. If you wish to track more than 10 cell phones, please contact me at nickfox@websmithing.com. 

== Screenshots ==

1. Gps Tracker Plugin 
2. Gps Tracker Android app turned off
3. Gps Tracker Android app turned on
