...
class Gps_Tracker {
	...
	public function enqueue_styles() {
        ...
        */
        // wp_enqueue_style( $this->plugin_slug . '-bootstrap-styles', plugins_url( '//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css', __FILE__ ), array(), self::VERSION );
        
        // wp_enqueue_style('gpstracker-bootstrap', '//maxcdn.bootstrapcdn.com/bootstrap/3.2.0/css/bootstrap.min.css', false, '3.2.0', 'all');
   
        wp_enqueue_style( $this->plugin_slug . '-leaflet-styles', plugins_url( 'assets/js/leaflet-0.7.3/leaflet.css', __FILE__ ), array(), self::VERSION );              
        wp_enqueue_style('gpstracker-bootstrap', '//maxcdn.bootstrapcdn.com/bootswatch/3.3.0/superhero/bootstrap.min.css', false, '3.3.0', 'all');
	...
	public function enqueue_scripts() {     
        wp_enqueue_script( $this->plugin_slug . '-google-maps', '//maps.google.com/maps/api/js?v=3&sensor=false&libraries=adsense', array(), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-map-js', plugins_url( 'assets/js/gpstracker-map.js', __FILE__ ), array('jquery'), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-leaflet-js', plugins_url( 'assets/js/leaflet-0.7.3/leaflet.js', __FILE__ ), array('jquery'), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-google-js', plugins_url( 'assets/js/leaflet-plugins/google.js', __FILE__ ), array('jquery'), self::VERSION );
        wp_enqueue_script( $this->plugin_slug . '-bing-js', plugins_url( 'assets/js/leaflet-plugins/bing.js', __FILE__ ), array('jquery'), self::VERSION );        
        
        wp_localize_script( $this->plugin_slug . '-map-js', 'map_js_vars', array(
